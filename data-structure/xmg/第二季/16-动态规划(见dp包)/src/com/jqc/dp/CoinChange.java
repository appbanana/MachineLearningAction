...
public class CoinChange {
    public static void main(String[] args) {
        System.out.println("coins1 = " + coins1(19));
        System.out.println("coins2 = " + coins2(19));
        System.out.println("coins3 = " + coins3(19));
        System.out.println("coins4 = " + coins4(19));
    ...
    static int coins3(int n) {
        ...
        for (int i = 1; i <= n; i++) {
            int min = dp[i - 1];
            if (i >= 5) min = Math.min(coins3(n - 5), min);
            if (i >= 20) min = Math.min(coins3(n - 20), min);
            if (i >= 25) min = Math.min(coins3(n - 25), min);
            dp[i] = min + 1;
        }
        return dp[n];
    }
